...
domain = [(50, 1150)] * (len(people) * 2)

geneticsolution = optimization.geneticoptimize(domain, crosscount, popsize=50, step=5, maxiter=100)
print('Schedule cost for genetic algorithm: {:d}'.format(crosscount(geneticsolution)))
drawnetwork(geneticsolution)

annealingsolution = optimization.annealingoptimize(domain, crosscount, step=50, cool=0.99)
drawnetwork(annealingsolution)
